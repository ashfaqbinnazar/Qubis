package com.example.hi.school.utils;
...
import com.example.hi.school.R;

public class VerticalTextView extends TextView {

    public final static int ORIENTATION_UP_TO_DOWN = 1;
    public final static int ORIENTATION_DOWN_TO_UP = 0;
